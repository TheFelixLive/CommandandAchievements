...
## Inhaltsverzeichnis
- [LLM.md - Large Language Model Documentation](#llmmd---large-language-model-documentation)
  - [ProjektÃ¼bersicht](#projektãbersicht)
  - [Hauptfunktionen](#hauptfunktionen)
  - [Technische Details](#technische-details)
- [Command \& Achievement Behavior Pack – Dokumentation](#command--achievement-behavior-pack--dokumentation)
  - [Inhaltsverzeichnis](#inhaltsverzeichnis)
  - [Projektübersicht](#projektübersicht)
  - [Hauptfunktionen](#hauptfunktionen-1)
  - [Technische Details](#technische-details-1)
  - [Wichtige Konstanten](#wichtige-konstanten)
  - [API‑Übersicht](#apiübersicht)
    - [Save‑Data‑Funktionen](#savedatafunktionen)
    - [Menü‑System](#menüsystem)
    - [Command‑System](#commandsystem)
  - [Command‑Syntax System (v2)](#commandsyntax-system-v2)
    - [Grundprinzip](#grundprinzip)
    - [Update‑Regeln (keine Breaking Changes)](#updateregeln-keine-breaking-changes)
    - [Einführung von `choice`](#einführung-von-choice)
      - [Struktur](#struktur)
      - [Verhaltensregeln](#verhaltensregeln)
  - [Best Practices \& Konsistenzregeln](#best-practices--konsistenzregeln)
  - [Hilfsfunktionen](#hilfsfunktionen)
  - [Entwicklungs‑ und Beitragsrichtlinien](#entwicklungs-und-beitragsrichtlinien)
  - [Synchronisation mit der offiziellen Dokumentation](#synchronisation-mit-der-offiziellen-dokumentation)
    - [Vorgehen bei zukünftigen Updates](#vorgehen-bei-zukünftigen-updates)
  - [Variablen \& aktueller Debug‑Stand](#variablen--aktueller-debugstand)
